...
export function RecommendedItem({
    ...
    return (
        <div
            className="relative cursor-pointer w-full h-[120px] rounded-xl overflow-hidden shadow-md hover:scale-[1.02] transition-transform duration-300 bg-cover bg-center">
