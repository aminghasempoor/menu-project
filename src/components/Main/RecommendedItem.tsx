    ...
    return (
        <div className={"flex items-center justify-center"}>
            <div className="relative w-full max-w-[600px] h-[160px] rounded-2xl overflow-hidden shadow-md mb-4">
                <Image src={Picture} alt="پیتزا مارگاریتا" fill className="object-fill" />
                ...
                <div className="absolute right-4 top-4 text-right space-y-1">
                    <p className="text-[13px] text-gray-500">آیتم پیشنهادی</p>
                    <h2 className="text-lg font-bold flex items-center text-black gap-1">پیتزا مارگاریتا</h2>
