        ...
        <div className="relative w-full h-screen overflow-hidden">
                ...
                <div className="relative z-20 flex flex-col items-center justify-center h-full text-white text-center space-y-6 px-4">
                    ...
                    <div className="flex gap-4 mt-6 flex-wrap justify-center">
                        <button onClick={() => selectMenu("cafe")} className="border border-white rounded-lg px-6 py-3 hover:bg-white/10 transition">
                            منوی کافه
                        </button>
                        <button onClick={() => selectMenu("restaurant")} className="border border-white rounded-lg px-6 py-3 hover:bg-white/10 transition">
                            منوی رستوران
                        </button>
                    </div>
